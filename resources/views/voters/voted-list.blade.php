        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Voted List</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body overflow-auto">
                            ...
                            <div class="row">
                                <div class="col">
                                    <p>This are the list of Voters Voted in the System.</p>
                                </div>
                                <div class="col-md-auto">
                                    <a href="{{ url('printVotedVoters') }}" class="btn btn-outline-primary" target="_blank">
                                        Print List
                                    </a>
                                </div>
                            </div>
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    @forelse ($voted as $voter)
                                        <tr>
                                            <td>
                                                <a href="{{ route('voters.show', $voter->id) }}" class="btn btn-primary btn-sm text-center w-100">{{ $voter->voter_id }}</a>
                                            </td>
