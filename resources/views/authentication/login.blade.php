                ...
                <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                    ...
                    <div class="card mb-3 shadow">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ url('loginUser') }}" method="POST" class="row g-3 needs-validation"
                                novalidate>
                                {{-- for validation --}}
                                @csrf
                                ...
                                <div class="col-12">
                                    <p class="small mb-0">Return to <a href="{{ url('/') }}">Welcome Page</a> ?</p>
                                ...
                                <div class="col-12">
                                    <p class="small mb-0">Don't have account? <a href="{{ url('registerNewVoter') }}">Create
                                            an account</a></p>
                                </div>
                            </form>
