    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="row g-3 align-items-center needs-validation" action="{{ route('candidates.store') }}"
                    ...
                    <div class="col-md-auto">
                        <div class="column g-1">
                            <div class="col-auto text-center">
                                ...
                                <img src="{{ asset('storage/candidate img/profile-img.jpg') }}"
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="floatingTextarea"
                                        placeholder="Partylist Title" name="partylist" required>
                                    <label for="floatingTextarea">Party List</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-floating mb-3">
                                    <select class="form-select" id="floatingSelect" aria-label="State" name="position"
                                        required>
                                    ...
                                    <label for="floatingSelect">Position to Run</label>
                                </div>
                            </div>
